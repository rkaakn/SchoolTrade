...
<div class="content" >
    ...
    <table style="text-align:center">
    	...
    	<c:forEach var="item" items="${recordList}">
    	    	<form action="AdminDelRoom" method="post" >
        	<tr>
      			<td>
       			${item.name}
      			</td>
            	...
            	<td>
            	    <input value="${record.RecordId}" name="recordId" type="hidden"/>
            		<input type="submit" value="删除" style="width:50px;height:50px" onclick="javascript:return del()"/>
            	</td>
     		</tr>
     			</form>
        </c:forEach>
